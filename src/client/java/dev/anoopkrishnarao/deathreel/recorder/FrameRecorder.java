...
public class FrameRecorder {
    ...
    public void record(LocalPlayer player) {
        frames[head] = new PlayerFrame(
                ...
                player.isCrouching(), player.isSprinting(), player.onGround(),
                player.getPose(),
    ...
    public void reset() { head = 0; size = 0; snapshotted = false; }
    public int getSize() { return size; }
    public boolean hasSnapshotted() { return snapshotted; }
}